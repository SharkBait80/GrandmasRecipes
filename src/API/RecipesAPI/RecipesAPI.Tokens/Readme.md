...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *RecipesAPI.Tokens*):

Restore dependencies
```
    cd "RecipesAPI.Tokens"
    dotnet restore
```

Execute unit tests
```
    cd "RecipesAPI.Tokens/test/RecipesAPI.Tokens.Tests"
    dotnet test
```

Deploy application
```
    cd "RecipesAPI.Tokens/src/RecipesAPI.Tokens"
