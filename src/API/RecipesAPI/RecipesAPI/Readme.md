...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *RecipesAPI*):
...
Execute unit tests
```
    cd "RecipesAPI/test/RecipesAPI.Tests"
    dotnet test
```

Deploy application
```
    cd "RecipesAPI/src/RecipesAPI"
